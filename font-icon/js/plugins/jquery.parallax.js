        ...
        this.init = function() {
            ...
            $(options.parent).mousemove(function(e){
                ...
                for(var key in options.subLayers) {
                    ...
                    //$(current[0]).css('margin-left', Math.round(layerPositionX[key]) + Math.round(deltaX*current[1]));
                    //$(current[0]).css('margin-top', Math.round(layerPositionY[key]) + Math.round(deltaY*current[1]));
                    $(current[0]).css('margin-left', (deltaX*current[1]));
                    $(current[0]).css('margin-top', (deltaY*current[1]));
                }
            });
        };
